    ...
    <main className="flex flex-1 items-center justify-center px-4">
      <div className="w-full max-w-md border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden p-8">
        ...
        <a
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-200 dark:border-gray-600 bg-transparent px-3 py-2 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
